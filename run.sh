...
JSONL_FILE="/path/to/workspace/models/mllm_attack/prompts/hades/vllm_input_0_750.jsonl"
LOCAL_MODEL_PATH="/path/to/models/Qwen2.5-VL-7B-Instruct"
MODEL_NAME="qwen25vl"

# test_baseline.py 的参数
INPUT_FILE="/path/to/workspace/models/mllm_attack/results/hades/vllm_input_0_750_qwen25vl_inference.jsonl"
GROUP_SIZE=150
