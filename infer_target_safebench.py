...
if __name__ == "__main__":
    ...
    parser.add_argument("--jsonl-file", type=str, default="/path/to/workspace/models/mllm_attack/prompts/safebench_ablation/vllm_input_0_400_nohint.jsonl", help="输入的jsonl文件路径")
    ...
    # 输出参数
    parser.add_argument("--output-dir", type=str, default="/path/to/workspace/models/mllm_attack/results/safebench_ablation",
                       help="推理结果保存目录")
